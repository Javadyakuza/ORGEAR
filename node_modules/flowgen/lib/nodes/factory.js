...
class Factory {
  constructor() {
    ...
    this._propDeclarations = void 0;
    this._functionDeclarations = void 0;

    this.createNamespaceNode = (node, name, context) => {
      let contextName;
    ...
    this.createImportNode = node => new _import.default(node);

    this.createExportNode = node => new _export.default(node);

    this.createExportDeclarationNode = node => new _exportDeclaration.default(node);
