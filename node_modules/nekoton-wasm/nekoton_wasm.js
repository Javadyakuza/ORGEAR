...
function __wbg_adapter_34(arg0, arg1, arg2) {
    wasm._dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__haca95bccbc691bb3(arg0, arg1, addHeapObject(arg2));
}
...
*/
export function executeLocal(config, account, message, utime, disable_signature_check, overwrite_balance) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        ...
        wasm.executeLocal(retptr, ptr0, len0, ptr1, len1, ptr2, len2, utime, disable_signature_check, ptr3, len3);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var r2 = getInt32Memory0()[retptr / 4 + 2];
        if (r2) {
...
function __wbg_adapter_171(arg0, arg1, arg2, arg3) {
    wasm.wasm_bindgen__convert__closures__invoke2_mut__h312c8790a30e233a(arg0, arg1, addHeapObject(arg2), addHeapObject(arg3));
}
...
export class GenericContract {
    ...
    */
    sendMessageLocally(message, params) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.genericcontract_sendMessageLocally(retptr, this.ptr, addHeapObject(message), addHeapObject(params));
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            if (r2) {
...
export class Transport {
    ...
    */
    getNetworkDescription() {
        const ret = wasm.transport_getNetworkDescription(this.ptr);
        return takeObject(ret);
    }
    /**
    ...
    */
    getSignatureId() {
        const ret = wasm.transport_getSignatureId(this.ptr);
        return takeObject(ret);
    }
    /**
    ...
    */
    getBlockchainConfig(force) {
        const ret = wasm.transport_getBlockchainConfig(this.ptr, isLikeNone(force) ? 0xFFFFFF : force ? 1 : 0);
        return takeObject(ret);
    }
    /**
    * @param {string} address
...
function getImports() {
    ...
    imports.wbg.__wbg_onMessageSent_6846663ea09b87cb = function(arg0, arg1, arg2) {
        getObject(arg0).onMessageSent(takeObject(arg1), takeObject(arg2));
    };
    imports.wbg.__wbg_onMessageExpired_94f5aff80017e6e4 = function(arg0, arg1) {
        getObject(arg0).onMessageExpired(takeObject(arg1));
    };
    imports.wbg.__wbg_onStateChanged_37d7666f16f6b76a = function(arg0, arg1) {
        getObject(arg0).onStateChanged(takeObject(arg1));
    };
    imports.wbg.__wbg_onTransactionsFound_e58ef82b9558f49d = function(arg0, arg1, arg2) {
    ...
    imports.wbg.__wbg_isLocal_639d7802a82a4ba6 = function(arg0) {
        const ret = getObject(arg0).isLocal();
        return ret;
    };
    imports.wbg.__wbg_send_e601f6ac0834c365 = function(arg0, arg1, arg2, arg3, arg4) {
        getObject(arg0).send(getStringFromWasm0(arg1, arg2), GqlQuery.__wrap(arg3), arg4 !== 0);
    };
    imports.wbg.__wbg_send_be67ecb74f9b2558 = function(arg0, arg1, arg2, arg3, arg4) {
