...
*/
export function executeLocal(config: string, account: string, message: string, utime: number, disable_signature_check: boolean, overwrite_balance?: string): TransactionExecutorOutput;
/**
* @param {string} tvc
* @param {string} contract_abi
...
export interface InitOutput {
  ...
  readonly executeLocal: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number) => void;
  ...
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__haca95bccbc691bb3: (a: number, b: number, c: number) => void;
  readonly __wbindgen_add_to_stack_pointer: (a: number) => number;
  readonly __wbindgen_free: (a: number, b: number) => void;
  readonly __wbindgen_exn_store: (a: number) => void;
  readonly wasm_bindgen__convert__closures__invoke2_mut__h312c8790a30e233a: (a: number, b: number, c: number, d: number) => void;
}
